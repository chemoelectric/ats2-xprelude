...
test24 () : void =
  let
    ...
    val- 0 = isinf (g0float_nan<fltknd> ())
    val- 0 = isinf (g0float_nan<dblknd> ())
    val- 0 = isinf (g0float_nan<ldblknd> ())
    ...
    val- 0 = isinf (g0float_snan<fltknd> ())
    val- 0 = isinf (g0float_snan<dblknd> ())
    val- 0 = isinf (g0float_snan<ldblknd> ())
    ...
    val- 1 = isinf (infinity<fltknd> ())
    val- 1 = isinf (infinity<dblknd> ())
    val- 1 = isinf (infinity<ldblknd> ())
    val- 1 = ~isinf (~infinity<fltknd> ())
    val- 1 = ~isinf (~infinity<dblknd> ())
    val- 1 = ~isinf (~infinity<ldblknd> ())
  in
