...
#define ATS_EXTERN_PREFIX "ats2_poly_fixed32p32_square_root_"
...
ats2_poly_fixed32p32_square_root__sqrt_initial_estimate
  (ats2_poly_fixed32p32 x)
{
  ...
  return ((ats2_poly_fixed32p32) 1) << (((bitsize - 1) >> 1) + 33);
}
